...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Script to perform testing on the KTH data set using the included SVM code.", 
             formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument("root", help="path to the directory containing the action bank processed kth files structured as in root/{train|test}/class/class000_banked.npy.gz for each class")
