...
echo "Output File: /nfs/bigeye/sdaptardar/ChaLearn/ChaLearn/thirdparty/SingleExample/log.${JOB_ID}.out"
echo "Error File:  /nfs/bigeye/sdaptardar/ChaLearn/ChaLearn/thirdparty/SingleExample/log.${JOB_ID}.err"
