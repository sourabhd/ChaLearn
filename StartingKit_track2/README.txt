...
This ZIP file contains the code provided for the Chalearn LAP competition:
	...
	- track2_demp.py: Main file, showing how to access the data, evaluate and create the final submission file.
...
To run the sample, just run the fle track2_demo.py:

	python track2_demo.py
